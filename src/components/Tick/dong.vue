...
<!-- 项目 -->
 <el-submenu index="1"  >
    ...
    <el-menu-item index="listDate" @click="isAddShow=true">新增项目</el-menu-item>
    <el-menu-item index="listDate" @click="AllProject">进行中项目</el-menu-item>
    <el-menu-item index="wan2">上线项目</el-menu-item>
    <el-menu-item index="listDate" @click="matterproject">问题项目</el-menu-item>
    </el-submenu>
<!-- 工单 -->
<el-submenu index="22">
    <template slot="title">工单</template>
    <el-menu-item   @click="popButton($event)">新增工单</el-menu-item>
    <el-menu-item index="square2">工单广场</el-menu-item>
    <el-menu-item index="wrok2"  @click="All">我的工单</el-menu-item>
    <el-menu-item index="wrok2" @click="waitFor">待处理工单</el-menu-item>

  </el-submenu>
<!-- 售后 -->
<el-submenu index="232">
    <template slot="title">售后</template>
    <el-menu-item index="sales2">外企点</el-menu-item>
...
<!-- <el-submenu index="33">
    ...
    <!-- <el-menu-item index="admin2">客户管理</el-menu-item>
  </el-submenu> -->
 <el-menu-item index="admin2">客户管理</el-menu-item>
<!-- 工作 -->
<!-- <el-submenu index="23">
    <template slot="title">工作</template>
    <el-menu-item index="jk">我的工作</el-menu-item>
  </el-submenu> -->
  <el-menu-item index="jk">我的工作</el-menu-item>
     <el-menu-item index="mas2">文件管理</el-menu-item>
